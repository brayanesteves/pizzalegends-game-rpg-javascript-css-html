class KeyboardMenu {
    ...
    setOptions(options) {
        ...
        this.element.innerHTML = this.options.map((option, index) => {
            ...
            return (`
                <div class="option">
                    <!--<button ${disabledAttr} ${autoFocusAttr} data-button="${index}" data-description="${option.description}">${option.label}</button>-->
        ...
        this.element.querySelectorAll("button").forEach((button) => {
            button.addEventListener("click", () => {
                const chosenOption = this.options[Number(botton.dataset.button)];
    ...
    createElement() {
        ...
        this.descriptionElement.innerHTML = (`<p> Will provide information!</p>`);
